    ...
    <>
      <div className="items_Tech_1">
        <div className="item_tech">
          ...
          >
            <g clip-path="url(#clip0_144_126)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M15 6C12.6131 6 10.3239 6.94821 8.63604 8.63604C6.94821 10.3239 6 12.6131 6 15V30H0V15C0 11.0218 1.58035 7.20644 4.3934 4.3934C7.20644 1.58035 11.0218 0 15 0L30 0V6H15ZM75 6H60V0H75C78.9782 0 82.7936 1.58035 85.6066 4.3934C88.4196 7.20644 90 11.0218 90 15V30H84V15C84 12.6131 83.0518 10.3239 81.364 8.63604C79.6761 6.94821 77.3869 6 75 6ZM30 36H24V30H30V36ZM66 36H60V30H66V36ZM29.4 52.2C31.2164 54.6218 33.5717 56.5875 36.2793 57.9413C38.987 59.2952 41.9727 60 45 60C48.0273 60 51.013 59.2952 53.7207 57.9413C56.4283 56.5875 58.7836 54.6218 60.6 52.2L65.4 55.8C55.2 69.402 34.8 69.402 24.6 55.8L29.4 52.2ZM0 75V60H6V75C6 77.3869 6.94821 79.6761 8.63604 81.364C10.3239 83.0518 12.6131 84 15 84H30V90H15C11.0218 90 7.20644 88.4196 4.3934 85.6066C1.58035 82.7936 0 78.9782 0 75ZM90 60V75C90 78.9782 88.4196 82.7936 85.6066 85.6066C82.7936 88.4196 78.9782 90 75 90H60V84H75C77.3869 84 79.6761 83.0518 81.364 81.364C83.0518 79.6761 84 77.3869 84 75V60H90Z"
                fill="#00D8FF"
              />
            </g>
            <defs>
          ...
          <p>
            StyleGAN2과 같은 AI를 통해 가상의 면접관 얼굴을 생성 후,
            <br />
            립싱크 기술을 통해 가상의 면접관을 구현
          </p>
        </div>
      </div>

      <div className="items_Tech_2">
        <div className="item_tech">
          <svg
            width={84}
            height={72}
